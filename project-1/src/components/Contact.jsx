  ...
  return (
    <div className="mt-20 px-4 sm:px-8">
      ...
      <div className=" flex flex-col  md:flex-row  items-center justify-between gap-8 mt-12 max-w-5xl mx-auto">
        <div className="font-bold text-2xl sm:text-3xl flex gap-6  mt-4">
        ...
        <div className="flex flex-col  sm:flex-row items-center gap-4 w-full sm:w-auto">
          <input
            ...
            className="mt-4 border border-black rounded-full w-full sm:w-72 h-12 text-center outline-none"
          />
