  ...
  return (
    <>
     <div className="flex flex-col lg:flex-row items-center justify-between w-[90%] mx-auto my-20">
              <div className=""></div>
              <h1 className='font-bold text-4xl uppercase text-[rgba(51,55,64,1)]'>Products</h1>
              <a href="" className='font-bold text-[rgba(255,191,61,1)] text-[20px] uppercase'>Filter</a>
          </div> 
